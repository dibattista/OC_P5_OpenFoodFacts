...
class ConnectDB:
    ...
    def insert_aliments(self, val_aliment, categories_id):
        ...
        # si dessous on récupère les valeurs pour chaque key scpecifique, trouver dans le get des aliments de api openfoodfacts
...
##### interaction user
    ...
    def get_categories(self):
        ...
        print('Choose a number from a categories list : ')
        for x in myresult:
            print(x)
    ...
    def get_aliment(self, categories_id):
        ...
        myresult = cursor.fetchall()
        print('Choose a number from a aliment list : ')
        for x in myresult:
            print(x)
    ...
    def get_substitute_aliment(self, categories_id, nutri_grade_choose):
        ...
        print('result substitute in get_substitute_aliment connectDB', random.choice(myresult))
